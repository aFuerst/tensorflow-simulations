...
int main(int argc, char* argv[]) 
{
  ...
  /**********************/
  double ljatom_density;	// this is taken in as mass density (in reduced units)
  int number_ljatom;		// total number of particles in your system
...
#pragma omp parallel default(shared)
  ...
  ofstream list_propagation("propagation.lammpstrj", ios::out); // create a file to store data; first line displays the labels
