...
def toggle_cpu(cpu, thread_count):
    if cpu:
        ...
        print("config.intra_op_parallelism_threads =", tf.config.intra_op_parallelism_threads)
        print("config.inter_op_parallelism_threads =", tf.config.inter_op_parallelism_threads)
