...
def _particle_electrostatic_force(simul_box, ion_dict):
    ...
    with tf.name_scope("particle_electrostatic_force"):
        ...
        h1_z_total_per_ion = tf.math.reduce_sum(h1_z_filtered, axis=1, keepdims=True)
        ...
        h1 = tf.math.reduce_sum(h1_per_ion, axis=1, keepdims=False, name="sum_a_times_b") #TODO: remove need for newaxis here  #-------------->>>>> change axis here to 0
