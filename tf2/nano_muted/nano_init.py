...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', "--pos-valency", action="store", default=0, type=int)  # changed from 1 to 0
    parser.add_argument('-en', "--neg-valency", action="store", default=0, type=int)  # changed from -1 to 0
